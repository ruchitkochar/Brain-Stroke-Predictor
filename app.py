...
def result():
    ...
    scaler_path='C:\\Users\\HP\\OneDrive\\Desktop\\Brain-Stroke-Predictor\\models\\scaler.pkl'
    scaler = None
    with open(scaler_path, 'rb') as scaler_file:
        scaler = pickle.load(scaler_file)
    x = scaler.transform(x)
    #model_path = os.path.join('C:/Users/HP/OneDrive/Desktop/Brain-Stroke-Predictor/', 'models/dt.sav')
    model_path='C:\\Users\\HP\\OneDrive\\Desktop\\Brain-Stroke-Predictor\\models\\dt.sav'
